...
- What inputs does the function need to achieve its goal? - The string value and the amount oftimes

- How can you iteratively build up the final string, using one of the inputs to control the repetition? - Done!
